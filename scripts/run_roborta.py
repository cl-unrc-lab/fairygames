...
# it runs roborta with several paramenters and the UAV with several paramenters
...
for g in roborta_grids:
    for v in roborta_vers:
        for p in roborta_pars:
            os.system("./fairy -erew -exportresults results/res_"+v+g+".txt "+"../fairness-examples/roborta/"+v+g+".smg -const "+p);
